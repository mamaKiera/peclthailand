      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 rounded-2xl bg-[#e5f2f2] gap-x-16 gap-y-8 p-8">
            太平洋管理科学大学国际部由繁荣教育门主办，繁荣教育门象征着通过这个平台引领你走向成功之路，由泰籍华裔学者陈秋声博士创立，目的是促进泰中两国高等教育的交流与合作，为中国培养高等教育人才。
            ...
            在陈秋声博士的领导下，繁荣教育门将他们多年累积的经验贡献给太平洋管理科学大学国际部，相信能为本学院的中国留学生提供最优质的教育和学习服务。
          </p>
          <ul
            role="list"
      ...
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <Image
              className="w-[36rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[50rem]"
              src={pimspecl}
              alt=""
            />
          </div>
